...
model = '
	...
	value_ITN_received ~ 1*expenditure_M1_1_cumulative + prior("dgamma(1,1)")*expenditure_M1_2_cumulative + prior("dgamma(1,1)")*other_dah_M1_1_cumulative + date
	value_RDT_received ~ 1*expenditure_M2_1_cumulative + prior("dgamma(1,1)")*expenditure_M2_3_cumulative + prior("dgamma(1,1)")*other_dah_M2_cumulative + prior("dgamma(1,1)")*other_dah_M2_3_cumulative + date
	value_ACT_received ~ 1*expenditure_M2_1_cumulative + prior("dgamma(1,1)")*expenditure_M2_3_cumulative + prior("dgamma(1,1)")*other_dah_M2_cumulative + prior("dgamma(1,1)")*other_dah_M2_3_cumulative + date
	...
	value_SP ~ prior("dgamma(1,1)")*expenditure_M3_1_cumulative
	value_severeMalariaTreated ~ 1*expenditure_M2_6_cumulative + prior("dgamma(1,1)")*value_ACT_received
	...
	# covariances
	expenditure_M1_1_cumulative ~~ other_dah_M1_1_cumulative
	expenditure_M1_2_cumulative ~~ other_dah_M1_1_cumulative
	expenditure_M2_1_cumulative ~~ other_dah_M2_cumulative
	expenditure_M2_1_cumulative ~~ other_dah_M2_cumulative
	expenditure_M2_6_cumulative ~~ other_dah_M2_cumulative
	expenditure_M2_3_cumulative ~~ other_dah_M2_3_cumulative
	
	value_ITN_consumed ~~ value_RDT_completed
	value_RDT_completed ~~ value_totalPatientsTreated
	
	# fixed covariances
	expenditure_M2_3_cumulative ~~ 0*expenditure_M3_1_cumulative
	expenditure_M2_3_cumulative ~~ 0*expenditure_M2_6_cumulative
	expenditure_M2_6_cumulative ~~ 0*expenditure_M3_1_cumulative
