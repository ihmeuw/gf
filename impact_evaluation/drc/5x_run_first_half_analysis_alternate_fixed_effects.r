...
modelVersion = 'drc_malaria6_time_trend_test'
# ---------------------------
...
qsubCommand = paste0('qsub -cwd -N ie1_job_array -t 1:', T, 
		...
		' ./core/r_shell_blavaan.sh ./impact_evaluation/drc/5x_run_single_model_alternate_fixed_effects.r ', 
...
outputFile5a = gsub('.rdata', 'time_fixed_effect.rdata', outputFile5a)
