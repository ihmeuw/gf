...
# This should make 4c and 4d irrelevant once confirmed that the model works
...
long_untr = melt(sample_untr, id.vars=c('health_zone','date'))
...
# --------------------------------
# Save file
print(paste('Saving:', outputFile4e)) 
pdf(outputFile4e, height=5.5, width=9)
