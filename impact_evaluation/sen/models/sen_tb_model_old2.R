...
model = '
    ...
    com_nom_touss_cumulative ~ lag_exp_T1_5_cumulative
    ...
    tb_tfc_cumulative ~ com_mobsoc_cumulative + tot_genexpert_cumulative + perf_lab + lag_other_dah_T1_1_cumulative + lag_exp_T1_1_cumulative
    
    perf_lab ~ lag_other_dah_T1_1_cumulative + lag_exp_T1_1_cumulative
    ntr_all_cumulative ~ lag_exp_R2_cumulative + lag_other_dah_R3_cumulative + com_mobsoc_cumulative + tb_tfc_cumulative + lag_other_dah_T1_2_cumulative + lag_exp_T1_2_cumulative
