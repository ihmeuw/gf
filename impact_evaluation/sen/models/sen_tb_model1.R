...
model = '
    ...
    tot_genexpert_cumulative ~ com_nom_touss_cumulative + lag_other_dah_T1_1_cumulative + lag_exp_T1_1_cumulative + lag_other_dah_T3_cumulative + lag_exp_T3_cumulative
    ...
    gueris_taux ~ tb_tfc_cumulative + tb_vih_arv_cumulative + com_mobsoc_cumulative + com_cause_cumulative + com_vad_touss_cumulative + com_radio_cumulative
