...
fgh_actual = allRT[data_source == "fgh" & fin_data_type == "actual"] #Split FGH between actual numbers and model estimates. 
fgh_estimates = allRT[data_source == "fgh" & fin_data_type != "actual"] 