...
model = '
  ...
  Number_of_Cases_Screened_for_MDR_act_cumulative ~ exp_T3_1_ALL + other_dah_T3_1_cumulative + date
 ...
 # Cases_Started_on_Treatment_out_cumulative ~ exp_T1_1_cumulative + ghe_T1_1_cumulative + other_dah_T1_1_cumulative + Isoniazid_Distributed_act_cumulative + date #Can add outreach if data come through
  MDR_Cases_Started_Treatment_out_cumulative ~ exp_T3_2_ALL + other_dah_T3_2_cumulative + Number_of_Cases_Screened_for_MDR_act_cumulative + date
