...
# gtm_tb_first_half9; gtm_tb_first_half10 - adding outcome indicators as well to last 1/3 of model EL 8/23/19 
# gtm_tb_first_half9.R was a typo and should be ignored! gmt_tb_first_half10 is exactly the same, with the extension '.r'. 
...
#gtm_tb_first_half11_rssh_interaction2: Rssh interaction term included for all input variables. 
#
...
model = '
  ...
  Firstline_Distributed_act_cumulative ~  ghe_tb_cumulative + ghe_tb_cumulative*gf_rssh_cumulative
  Secondline_Distributed_act_cumulative ~ gf_mdrtb_cumulative + gf_mdrtb_cumulative*gf_rssh_cumulative 
  Number_of_Cases_Screened_for_MDR_act_cumulative ~ gf_mdrtb_cumulative + gf_mdrtb_cumulative*gf_rssh_cumulative +  ghe_tb_cumulative + ghe_tb_cumulative*gf_rssh_cumulative + odah_tb_cumulative + odah_tb_cumulative*gf_rssh_cumulative
  TB_Patients_Tested_for_HIV_act_cumulative ~ gf_tbhiv_cumulative + gf_tbhiv_cumulative*gf_rssh_cumulative +  ghe_tb_cumulative + ghe_tb_cumulative*gf_rssh_cumulative + odah_tb_cumulative + odah_tb_cumulative*gf_rssh_cumulative 
  ...
  Cases_Notified_out_cumulative  ~ Additional_Cases_Detected_via_ACF_out_cumulative + gf_tb_cumulative + gf_tb_cumulative*gf_rssh_cumulative +  ghe_tb_cumulative + ghe_tb_cumulative*gf_rssh_cumulative + odah_tb_cumulative + odah_tb_cumulative*gf_rssh_cumulative 
  Cases_Started_on_Treatment_out_cumulative ~ gf_tb_cumulative + gf_tb_cumulative*gf_rssh_cumulative +  ghe_tb_cumulative + ghe_tb_cumulative*gf_rssh_cumulative + odah_tb_cumulative + odah_tb_cumulative*gf_rssh_cumulative + Firstline_Distributed_act_cumulative + Cases_Notified_out_cumulative
