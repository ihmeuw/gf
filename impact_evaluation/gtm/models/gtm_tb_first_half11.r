...
model = '
  ...
  Cases_Started_on_Treatment_out_cumulative ~ gf_tb_cumulative +  ghe_tb_cumulative + odah_tb_cumulative + Firstline_Distributed_act_cumulative + Cases_Notified_out_cumulative
