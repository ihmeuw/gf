...
# Merge the data sets you have downloaded
# Import base services data set and convert to a data table

# original download - 2015 to april 2017
base1 <- readRDS(paste0(dir, 'pre_merge/base/base_services_drc_01_2015_04_2018.rds'))
