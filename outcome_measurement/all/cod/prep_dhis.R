...
base <- base[ ,.(data_set, element, date, category, age, sex, type, value, org_unit, group,
         coordinates, opening_date, last_update, drug, svs, element_fr, element_id, 
         org_unit_id, data_set_id, year, month)]
