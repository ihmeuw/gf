...
```{r reporting1, echo=FALSE}
# Run for Determine test kits, but could also run for all drugs? 
g1 = gen_report1(dt, drugs[call=="DETERMINE", drug_id], drugs[call=="DETERMINE", drug_name], full_date_range)
g1
```

## Reporting Completeness
```{r reporting2, echo=FALSE}
g2 = gen_report2(dt, drugs[call=="DETERMINE", drug_id], drugs[call=="DETERMINE", drug_name], full_date_range)
g2
```
...
```{r stockout1, echo=FALSE}
g3 = gen_stockout1(dt, drugs[call=="DETERMINE", drug_id], drugs[call=="DETERMINE", drug_name], full_date_range)
g3
```
