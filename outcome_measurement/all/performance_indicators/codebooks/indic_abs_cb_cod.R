...
# data to be subset
s1y2019pudrs = data[loc_name=="cod" & start_date_programmatic >= "2019-01-01" & end_date_programmatic <= "2019-06-30",.(indicator_code, in2019s1=1)]
s2y2018pudrs = data[loc_name=="cod" & start_date_programmatic >= "2018-01-01" & end_date_programmatic <= "2018-12-31",.(indicator_code, in2018s2=1)]
s1y2018pudrs = data[loc_name=="cod" & start_date_programmatic >= "2018-01-01" & end_date_programmatic <= "2018-06-30",.(indicator_code, in2018s1=1)]
...
# save outfile
outFile = "C:/Users/frc2/Documents/gf/outcome_measurement/all/performance_indicators/codebooks/indic_absrp_cb_cod.RDS"
saveRDS(final_file2, outFile)
outFile2 = "C:/Users/frc2/Documents/gf/outcome_measurement/all/performance_indicators/codebooks/indic_absrp_cb_cod.csv"
