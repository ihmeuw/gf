...
DT = DT[,.(loc_name, grant, brief_description_code, ihme_result_achievement_ratio, reporting_period)]
...
# subset data
DT4 = DT3[,.(loc_name, grant, brief_description_code, res, date)]

# remove missing values
DT4 = na.omit(DT4)

# save file for export
outputFile = "J:\\Project\\Evaluation\\GF\\outcome_measurement\\multi_country\\performance_indicators\\pudr_indicator_extraction\\visualizations\\cross_consortia_data.csv"
