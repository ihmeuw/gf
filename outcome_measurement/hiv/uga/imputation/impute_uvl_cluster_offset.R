...
imputed_data <- amelia(uvl, m=50, cs='cs_variable', ts='date', lags=lagVars, leads=lagVars, idvars=idVars, noms='district_id', ords='level', parallel='multicore', ncpus=ncores, p2s=2)
...
#--------------------------------------------------------------
# Models with polytime - time squared
# run imputation using amelia
...
imputed_time2 <- amelia(uvl, m=50, cs='cs_variable', ts='date', lags=lagVars, leads=lagVars, idvars=idVars, noms='district_id', ords='level', polytime=2, parallel='snow')
...
imputed_time3 <- amelia(uvl, m=50, cs='cs_variable', ts='date', lags=lagVars, leads=lagVars, idvars=idVars, noms='district_id', ords='level', polytime=3, parallel='snow')
