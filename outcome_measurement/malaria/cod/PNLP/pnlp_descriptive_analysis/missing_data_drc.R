...
# ----------------------------------------------
# Use the function is.na() to create a binary variable containing 1s to indicate if the value is missing
    # and 0s to indicate if there is data for that value.
