...
keep <- c('com_nom_touss', 'com_vad_touss') # choose indicators to keep ###
...
outputFilePath = "J:/Project/Evaluation/GF/impact_evaluation/sen/data_quality_tests/tb/home_visits_referred.pdf"
