...
keep <- c('com_nom_touss', 'com_enf_ref') # choose indicators to keep ###
...
outputFilePath = "J:/Project/Evaluation/GF/impact_evaluation/sen/data_quality_tests/tb/cough_children_referred.pdf"
