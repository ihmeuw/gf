...
ggsave(paste0(gtm_save, "/module_categories_hiv.png"), plot = gtm_hiv_modules_10_20, height=6, width=14)
ggsave(paste0(gtm_save, "/module_categories_hiv.pdf"), plot = gtm_hiv_modules_10_20, height=6, width=14)

gtm_tb_modules_10_20 <- modules_over_time("Guatemala", "tb", 2010, 2020)
ggsave(paste0(gtm_save, "/module_categories_tb.png"), plot = gtm_tb_modules_10_20, height=6, width=14)
ggsave(paste0(gtm_save, "/module_categories_tb.pdf"), plot = gtm_tb_modules_10_20, height=6, width=14)

gtm_mal_modules_10_20 <- modules_over_time("Guatemala", "malaria", 2010, 2020)
ggsave(paste0(gtm_save, "/module_categories_mal.png"), plot = gtm_mal_modules_10_20, height=6, width=14)
ggsave(paste0(gtm_save, "/module_categories_mal.pdf"), plot = gtm_mal_modules_10_20, height=6, width=14)
