...
#Return a graph of the funding landscape for the given years using fgh data, by country and disease (Inputs). 
#   ***Can we make this into a stacked area plot?***
funding_landscape = function(country_name, disease_name, start_year, end_year){
  plot_data = fgh[country == country_name & disease == disease_name]
