...
```{r rssh_budget_exp, fig.height=15} 
  ...
  ggsave(paste0(save_loc, "rssh.png"), grid.arrange(p1, p2, ncol=1), fig.height=15, fig.width=10)
...
plot_data = budgets[grant_disease=="tb" & abbrev_int=="Case detection and diagnosis", .(budget=sum(budget, na.rm=T)), by=c('abbrev_mod', 'start_date')]
