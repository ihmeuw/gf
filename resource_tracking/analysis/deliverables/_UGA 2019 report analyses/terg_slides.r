...
p1 = budget_exp_bar(cumul_abs_grant, xVar='grant', altTitle="Cumulative from start of grant", altSubtitle="January 2018-June 2019")
...
recent_abs_grant = absorption[semester=="Semester 3" & grant_period=="2018-2020", .(budget=sum(budget, na.rm=T), expenditure=sum(expenditure, na.rm=T)), 
                              by=c('grant')]
p2 = budget_exp_bar(recent_abs_grant, xVar='grant', altTitle="Most recent semester reporting", altSubtitle="January 2019-June 2019")
