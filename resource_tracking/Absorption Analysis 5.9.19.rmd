...
dir = paste0(j, "Project/Evaluation/GF/resource_tracking/_gf_files_gos/combined_prepped_data/")
setwd(dir)
expenditures = readRDS(paste0(dir, "final_expenditures.rds"))
...
# Make budget and expenditure 0 where there is NA
pudrs[is.na(budget), budget:=0]
pudrs[is.na(expenditure), expenditure:=0]
...
*Numbers shown are pooled across all IHME PCE countries*
