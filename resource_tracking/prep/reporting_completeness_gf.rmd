...
gos_data = readRDS("J:/Project/Evaluation/GF/resource_tracking/_gf_files_gos/gos/prepped_data/raw_bound_gos.rds")
  
pudr_subset = pudrs[year>=2015]
gos_data = gos_data[year<2015]
