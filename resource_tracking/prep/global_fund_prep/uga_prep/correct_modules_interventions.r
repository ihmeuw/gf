...
correct_modules_interventions <- function(resource_database){
  ...
  resource_database[intervention == 'pleaseselect', intervention:='all']
  ...
  #EKL 2/5/19 
  resource_database[module == 'hsshealthsystemsstrengtheninghss', module:='hsshealthsystemsstrengthening']
