...
uga_codebook <- data.table(read_excel("H:/other_gf_projects/RT_Codebook.xlsx"))
```
...
knitr::include_graphics("H:/other_gf_projects/fpmimage.png")
```
...
knitr::include_graphics("H:/other_gf_projects/pudrimage.png")
```
...
knitr::include_graphics("H:/other_gf_projects/githubimage.png")
```
...
knitr::include_graphics("H:/other_gf_projects/ugabasecampimage.png")
```
