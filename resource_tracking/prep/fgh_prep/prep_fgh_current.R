...
fghData$fin_data_type <- "estimates"
fghData$code <- "s98"
...
setnames(ghe_data, c("location_id", "year_id"), c("adm1", "year"))
...
ghe_cleaned <- ghe_wide[, c("adm1", "year", "mean_dah", "lower_dah", "upper_dah", "lower_oop_ppp_ghe_agg", "mean_oop_ppp_ghe_agg", "upper_oop_ppp_ghe_agg",
