...
cumulative[, cumulative:=sum(`Semester 1-2`, `Semester 3`, na.rm=T), by=c('grant', 'grant_disease', 'variable')]
...
#   scale_fill_manual(values=c('plum2', 'chocolate2')) + 
#   scale_y_continuous(labels = scales::dollar) + 
#   labs(title=paste0("Cumulative budget and expenditure for ", g), x="Module", y="Amount ($)", fill="", 
#        subtitle="Labels show expenditure amounts")
#  print(p4)
 # if (i<4){cat("\n\n\\pagebreak\n")} 
