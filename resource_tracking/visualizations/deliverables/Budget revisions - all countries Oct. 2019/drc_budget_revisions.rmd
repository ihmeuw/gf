...
ggplot(by_module[grant=="COD-M-MOH"], aes(x=abbrev_mod_eng, y=budget, fill=version)) + 
...
ggplot(by_intervention[grant=="COD-M-MOH" & abbrev_mod_eng=="Vector control"], aes(x=abbrev_int_eng, y=budget, fill=version)) + 
  geom_bar(stat="identity", position="dodge") + 
  # geom_text(data=by_module, aes(x=abbrev_mod_eng, y=budget, label=label), vjust=0) + 
  theme_bw() + 
  coord_flip() + 
...
ggplot(by_module[grant=="COD-M-SANRU"], aes(x=abbrev_mod_eng, y=budget, fill=version)) + 
  geom_bar(stat="identity", position="dodge") + 
  # geom_text(data=by_module, aes(x=abbrev_mod_eng, y=budget, label=label), vjust=0) + 
  theme_bw() + 
...
ggplot(by_intervention[grant=="COD-M-SANRU" & abbrev_mod_eng=="Vector control"], aes(x=abbrev_int_eng, y=budget, fill=version)) + 
  geom_bar(stat="identity", position="dodge") + 
  # geom_text(data=by_module, aes(x=abbrev_mod_eng, y=budget, label=label), vjust=0) + 
  theme_bw() + 
  coord_flip() + 
...
ggplot(by_module[grant=="COD-C-CORDAID"], aes(x=abbrev_mod_eng, y=budget, fill=version)) + 
  geom_bar(stat="identity", position="dodge") + 
  # geom_text(data=by_module, aes(x=abbrev_mod_eng, y=budget, label=label), vjust=0) + 
  theme_bw() + 
  theme(axis.text.x=element_text(angle=30, vjust=0.5)) + 
...
ggplot(by_intervention[grant=="COD-C-CORDAID" & abbrev_mod_eng=="Program mgmt"], aes(x=abbrev_int_eng, y=budget, fill=version)) + 
  geom_bar(stat="identity", position="dodge") + 
  # geom_text(data=by_module, aes(x=abbrev_mod_eng, y=budget, label=label), vjust=0) + 
  theme_bw() + 
  coord_flip() + 
