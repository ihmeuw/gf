...
guide <- shp4[,c("NAME_1","GID_1", "NAME_2","GID_2", "NAME_3", "GID_3", "NAME_4", "GID_4")]

# set names of columns
setnames(guide, 
         c("NAME_1","GID_1", "NAME_2","GID_2", "NAME_3", "GID_3", "NAME_4", "GID_4"),
         c("Region1", "GID_1", "Department2", "GID_2", "Arrondissement3", "GID_3",  "Commune4", "GID_4"))

# save as a csv to preserve encoding
setwd("J:/Project/Evaluation/GF/mapping/sen/")
